...
<div class="detail-hero">
    ...
    <img src="<?= upload_url("users/{$user['id']}/other/{$item['hero_image']}") ?>" alt="<?= e($item['name']) ?>"
         ...
         data-full="<?= upload_url("users/{$user['id']}/other/{$item['hero_image']}") ?>">
    <?php else: ?>
    ...
    <div>
        ...
        <div class="detail-section">
            ...
            <div class="image-gallery">
                ...
                <div class="image-gallery-item"><img src="<?= upload_url("users/{$user['id']}/other/" . str_replace('.', '_thumb.', $image['filename'])) ?>" alt="Additional image" loading="lazy"
                     class="clickable-image"
                     data-gallery="other-<?= $item['id'] ?>"
                     data-full="<?= upload_url("users/{$user['id']}/other/{$image['filename']}") ?>"></div>
                <?php endforeach; ?>
            </div>
        </div>
        <?php endif; ?>
